...
Créer une ouverture à la Super Mario 3

## Démarrer

L'ouverture de Super Mario 3 est un lever de rideau.

Pour le rideau, pas la peine de dessiner la totalité, on peut répéter un repli sur tout l'écran.

Pour le reste pas de grosse difficulté, si vous avez relevé les défis précédents.

## Une solution

🐍 [Voir le fichier](day16.py)
