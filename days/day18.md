...
Créer un jeu de labyrinthe (2/2).
...
La seconde partie partie de ce défi consiste à mettre en place les mécanismes de jeu et notamment le mouvement de la bille.

La bille est soit en mouvement soit à l'arrêt. 

Quand elle est en mouvement, on ne prend pas en compte les appuis sur les touches. La bille s'arrête quand elle touche un mur (détection de couleur devant la bille) ou tombe du plateau (détection de couleur derrière la bille).

Une petite animation permet de croire au mouvement (lumière) et à la chute de la bille (réduction du rayon).

Quand elle est à l'arrêt, on prend en compte les appuis sur les touches flêches et on lance le mouvement de la bille .

Il ne reste qu'à détecter la chute de la bille dans le trou d'arrivée et à gérer les changements de niveau.

## Une solution

🐍 [Voir le fichier](day18.py)
