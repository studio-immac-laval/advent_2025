...
Créons un jeu de [Chrome Dino](https://en.wikipedia.org/wiki/Dinosaur_Game) avec Rudolf ! (4/4)
...
+   une difficulté évolutive (plus rapide, plus d'obstacles...)

+   la possibilité de planer quelques instants pour Rudolf (avec un effet arc-en-ciel 🌈)

## Une solution

🐍 [Voir le fichier](day24.py)
